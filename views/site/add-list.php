        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body list-container">
                    <div class="row">
                        <div class="col-md-12"><?= $form->field($model, 'theme_id')->dropDownList($array, ['options'=>[Yii::$app->session->get('theme')=>['Selected' => true]], 'data-route'=>Url::toRoute('site/list-hour')]) ?>
                        </div>
                    </div>
                    <div class="row">
